...
export class Repository {
    ...
    getEmailAuthentication = (method, url, token, data, contentType) => {
        const headers = Boolean(token) ? {'Email-Auth-Token': token, 'Content-Type': (contentType ? contentType : 'application/json')} : {};
