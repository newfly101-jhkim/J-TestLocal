...
class MyPage extends React.Component {
    ...
    // componentDidMount() {
    //     this.props.authStore.startChangeInfo()
    // }
    ...
    render() {
        ...
        // console.log(authStore.realUpdateTime, authStore.loginUser)
        console.log(authStore.loginUser.enabled)
                                    ...
                                    {authStore.renameSwitch
                                        ...
                                        <FormControl>
                                            ...
                                            <RadioGroup
                                                ...
                                                // onChange={(e)=>authStore.handleOnChangeStatus(e.target.value)}
                                            ...
                                            >
                                                ...
                                                {/*<FormControlLabel control={<Radio/>} label={"활성화"} value={true} />*/}
                                                {/*<FormControlLabel control={<Radio/>} label={"비활성화"} value={false} />*/}
                                            </RadioGroup>
                                        </FormControl>
                                    }
                                    {authStore.renameSwitch
