...
export default class AuthStore {
    ...
    // startChangeInfo = () => {
    //     this.realUpdateTime = this.loginUser.updatedDatetime;
    // }
    ...
    //     this.loginUser.enabled = changeStatus === "활성화" ? true : false;
    //     // this.loginUser.enabled = changeStatus;
    //     // this.loginUser.enabled ? "활성화" : "비활성화";
    // }
    // handleOnChangeStatus = (changeStatus) => {
    //     this.loginUser.enabled = changeStatus.target.value === "활성화" ? true : false;
    //     // this.loginUser.enabled = changeStatus;
    //     // this.loginUser.enabled ? "활성화" : "비활성화";
    // }
    handleOnChangeStatus = (changeStatus) => {
